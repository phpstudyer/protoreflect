...
[![Build Status](https://travis-ci.com/phpstudyer/protoreflect.svg?branch=master)](https://travis-ci.com/github/phpstudyer/protoreflect/branches)
[![Go Report Card](https://goreportcard.com/badge/github.com/phpstudyer/protoreflect)](https://goreportcard.com/report/github.com/phpstudyer/protoreflect)
...
[![GoDoc](https://godoc.org/github.com/phpstudyer/protoreflect?status.svg)](https://godoc.org/github.com/phpstudyer/protoreflect)

----
## Descriptors: The Language Model of Protocol Buffers

```go
import "github.com/phpstudyer/protoreflect/desc"
```
...
*[Read more ≫](https://godoc.org/github.com/phpstudyer/protoreflect/desc)*

```go
import "github.com/phpstudyer/protoreflect/desc/protoparse"
```
...
*[Read more ≫](https://godoc.org/github.com/phpstudyer/protoreflect/desc/protoparse)*

```go
import "github.com/phpstudyer/protoreflect/desc/protoprint"
```
...
*[Read more ≫](https://godoc.org/github.com/phpstudyer/protoreflect/desc/protoprint)*

```go
import "github.com/phpstudyer/protoreflect/desc/builder"
```
...
*[Read more ≫](https://godoc.org/github.com/phpstudyer/protoreflect/desc/builder)*

----
## Dynamic Messages and Stubs

```go
import "github.com/phpstudyer/protoreflect/dynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/phpstudyer/protoreflect/dynamic)*

```go
import "github.com/phpstudyer/protoreflect/dynamic/grpcdynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/phpstudyer/protoreflect/dynamic/grpcdynamic)*

----
## gRPC Server Reflection

```go
import "github.com/phpstudyer/protoreflect/grpcreflect"
```
...
*[Read more ≫](https://godoc.org/github.com/phpstudyer/protoreflect/grpcreflect)*
